<template>
  <section class="index pt-20">
    ...
    <section class="mx-10 flex">
        ...
        <section class="mx-10">
          <div class="grid
            ...
            <nuxt-link :to="'/products/' + category + '/' + product._id"
              class="product transition duration-150 ease-in-out cursor-pointer w-full px-2 pt-4 pb-2 hover:shadow-lg border rounded"
      ...
      <MainFilter class="flex-initial mt-10" :category="category"/>
    </section>
  </section>
</template>
